const app = (() => {
    ...
    const notifyButton = document.querySelector('.banner');
    ...
    function displayNotification() {
      ...
      if (Notification.permission == 'granted') {
        navigator.serviceWorker.getRegistration().then(reg => {
          ...
          reg.showNotification('Subcribe to our newsletter to know more ~', options);
        });
      }
    ...
    const applicationServerPublicKey = 'BP7GLhoYPg0_GfaLloGJmglEVN15lAoEHjQtstFB1dP0wR5cPoZRAjXuBWBpsGWzJ56jVEyZD23-4iQL4Q1Gu40';
